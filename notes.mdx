...
Trim newline: strings.TrimSpace removes \n so the conversion works.

Convert to int: strconv.Atoi converts the string input to an integer.

Use integers in printf: Now %d works since num1, num2, and sum are int.
